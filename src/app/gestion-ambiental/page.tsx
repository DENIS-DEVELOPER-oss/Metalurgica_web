  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12">
      <section className="mb-16">
        ...
        <h2 className="text-3xl font-bold text-primary mb-4">Nuestro Compromiso Ambiental</h2>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-primary mb-8">Áreas de Enfoque</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { title: "Reciclaje de Metales", description: "Desarrollamos técnicas avanzadas para el reciclaje eficiente de metales, reduciendo la necesidad de extracción de nuevos recursos.", icon: <Recycle className="h-12 w-12 text-green-500 mb-4" />, hint: "metal recycling" },
            { title: "Procesos de Producción Limpia", description: "Investigamos y aplicamos métodos de producción que minimizan emisiones y residuos en los procesos metalúrgicos.", icon: <Factory className="h-12 w-12 text-blue-500 mb-4" />, hint: "clean factory" },
            { title: "Gestión de Aguas Residuales", description: "Implementamos sistemas avanzados de tratamiento de aguas para reducir el impacto ambiental de los procesos metalúrgicos.", icon: <Droplets className="h-12 w-12 text-cyan-500 mb-4" />, hint: "water treatment" },
            { title: "Restauración Ecológica", description: "Desarrollamos estrategias para la recuperación de ecosistemas afectados por actividades mineras y metalúrgicas.", icon: <Leaf className="h-12 w-12 text-yellow-500 mb-4" />, hint: "plant restoration" },
          ].map((item, index) => (
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-primary mb-8">Proyectos de Investigación Ambiental</h2>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-primary mb-4">Educación y Concienciación</h2>
        <p className="text-lg text-muted-foreground mb-6">
        ...
        <ul className="space-y-3">
          {[
            ...
            <li key={index} className="flex items-center bg-card rounded-lg shadow p-4">
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold text-primary mb-4">Colaboraciones y Alianzas</h2>
        <p className="text-lg text-muted-foreground mb-6">
      ...
      <section className="mb-12 bg-green-50 dark:bg-green-900/30 rounded-lg p-8 text-center shadow-lg">
