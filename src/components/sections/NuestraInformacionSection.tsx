...
const topNavItems = [
  ...
  { title: 'Infraestructura', icon: <Building2 className="h-8 w-8 text-primary" />, href: '/nuestra-informacion/infraestructura' }, // Updated href
  { title: 'Organigrama', icon: <Network className="h-8 w-8 text-primary" />, href: '#' }, // Assuming organigrama is not yet created
];
